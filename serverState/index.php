...
$host = "mc.jiahewufwq.space"; //设置服务器域名或 IP
$port = "10000"; //设置服务器端口，可以直接用服务器的链接端口，也可以使用query端口（UDP协议）
$name = 'jiahewu'; // 服务器名字，会显示在标签页的标题和网站打头的大标题处
$iconlink = '../favicon.ico'; // 网站图标链接，可以使图片格式（.png/.jpg/etc.）或者是ico图标，用绝对路径或相对路径均可
$description = '| 感谢 <a href="https://bili33.top">GamerNoTitle</a> 提供查询服务支持 |<br>
源码： <a href="https://github.com/GamerNoTitle/Minecraft-Server-Status">Github</a>'; // 描述，会显示在大标题的下方，用html语法写就可以了，换行请用<br>
$imagelink = '../assets/images/TATySMPIcon.png'; // 图片链接，会显示在服务器信息右边的圈圈里
/*
$host = $_GET["host"];
$port = $_GET["port"];
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<span class="logo"><img src="../assets/images/TATySMPlogo.png" alt="" /></span>
